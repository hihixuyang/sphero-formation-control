function out = BaslerCam
%BASLERCAM Code for creating a video input object.
%   
%   This is the machine generated representation of a video input object.
%   This MATLAB code file, BASLERCAM.M, was generated from the OBJ2MFILE function.
...
%   type the name of the code file, BaslerCam, at the MATLAB command prompt.
%   
%   The code file, BASLERCAM.M and its associated MAT-file, BASLERCAM.MAT (if
...
try
    MATvar = load('C:\Users\mihai\Dropbox\Uni TUHH\Sem 3\Project\BaslerCam');
    MATLoaded = true;
catch
...
% Configure properties whose values are saved in C:\Users\mihai\Dropbox\Uni TUHH\Sem 3\Project\BaslerCam.mat.
if (MATLoaded)
